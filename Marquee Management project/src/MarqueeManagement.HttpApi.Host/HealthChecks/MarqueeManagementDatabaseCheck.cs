...
public class MarqueeManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MarqueeManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
