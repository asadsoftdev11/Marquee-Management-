...
public class MarqueeManagementDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MarqueeManagementGlobalFeatureConfigurator.Configure();
        MarqueeManagementModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MarqueeManagementDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MarqueeManagementResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MarqueeManagement");

            options.DefaultResourceType = typeof(MarqueeManagementResource);
        ...
        {
            options.MapCodeNamespace("MarqueeManagement", typeof(MarqueeManagementResource));
        });
    }
}
