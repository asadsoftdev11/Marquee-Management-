...
public class MarqueeManagementEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<MarqueeManagementDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also MarqueeManagementDbContextFactory for EF Core tooling. */
       options.UseNpgsql();
