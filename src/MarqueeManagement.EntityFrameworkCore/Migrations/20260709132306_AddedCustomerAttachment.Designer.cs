...
namespace MarqueeManagement.Migrations
{
    ...
    [Migration("20260709132306_AddedCustomerAttachment")]
    partial class AddedCustomerAttachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarqueeManagement.BookingMenuOptions.BookingMenuOption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PriceAtBookingTime");

                    b.HasIndex("Quantity");

                    b.ToTable("AppBookingMenuOptions", (string)null);
                });

            modelBuilder.Entity("MarqueeManagement.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GuestCount");

                    b.HasIndex("MarqueeId");
            ...
            modelBuilder.Entity("MarqueeManagement.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarqueeManagement.FileAttachments.FileAttachment", b =>
                {
                    ...
                    b.ToTable("AppFileAttachments", (string)null);
                });

            modelBuilder.Entity("MarqueeManagement.Marquees.Marquee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMarquees", (string)null);
                });

            modelBuilder.Entity("MarqueeManagement.MenuCategories.MenuCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarqueeManagement.MenuItems.MenuItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarqueeManagement.BookingMenuOptions.BookingMenuOption", b =>
                {
                    b.HasOne("MarqueeManagement.Bookings.Booking", "Booking")
                        .WithMany("BookingMenuOptions")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarqueeManagement.MenuItems.MenuItem", "MenuItem")
                        .WithMany("BookingMenuOptions")
            ...
            modelBuilder.Entity("MarqueeManagement.Bookings.Booking", b =>
                {
                    b.HasOne("MarqueeManagement.Customers.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarqueeManagement.Marquees.Marquee", "Marquee")
                        .WithMany("Bookings")
                        .HasForeignKey("MarqueeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MarqueeManagement.MenuItems.MenuItem", b =>
                {
                    b.HasOne("MarqueeManagement.MenuCategories.MenuCategory", "MenuCategory")
                        .WithMany("MenuItems")
            ...
            modelBuilder.Entity("MarqueeManagement.Bookings.Booking", b =>
                {
                    b.Navigation("BookingMenuOptions");
                });
