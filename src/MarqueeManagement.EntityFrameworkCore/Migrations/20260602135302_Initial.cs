    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(86)", maxLength: 86, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    MarqueeId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookings_AppMarquees_MarqueeId",
                        column: x => x.MarqueeId,
                        principalTable: "AppMarquees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AppBookingMenuOptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    PriceAtBookingTime = table.Column<decimal>(type: "numeric", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookingMenuOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookingMenuOptions_AppBookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "AppBookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookingMenuOptions_AppMenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBookingMenuOptions_BookingId",
                table: "AppBookingMenuOptions",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookingMenuOptions_MenuItemId",
                table: "AppBookingMenuOptions",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookingMenuOptions_PriceAtBookingTime",
                table: "AppBookingMenuOptions",
                column: "PriceAtBookingTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookingMenuOptions_Quantity",
                table: "AppBookingMenuOptions",
                column: "Quantity");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookings_CustomerId",
                table: "AppBookings",
                column: "CustomerId");
